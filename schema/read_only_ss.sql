...
CREATE SNAPSHOT similar_books REFRESH FAST AS SELECT * FROM similar_books@schmast;
...
BEGIN
   ...
   dbms_refresh.make(
      ...
      list => 'BOOK,BOOK_CATEGORIES,BOOK_INFO,CATEGORY,CATEGORY_INFO,CUSTOMER,CUSTOMER_ADDRESSES,CUSTOMER_ORDERS,CUSTOMER_REVIEWS,LANGUAGES,ORDER_ITEMS,PAYMENT_METHODS,PRICES,SIMILAR_BOOKS,TRANSLATION_STATUS',
      next_date => SYSDATE,
