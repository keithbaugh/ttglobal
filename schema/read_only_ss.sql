...
BEGIN
   ...
   dbms_refresh.make(
      name => 'bookstore_copy_group',
      list => 'BOOK,BOOK_INFO,CATEGORY,CATEGORY_INFO,CUSTOMER,CUSTOMER_ADDRESSES,CUSTOMER_ORDERS,CUSTOMER_REVIEWS,LANGUAGES,ORDER_ITEMS,PAYMENT_METHODS,PRICES,RECOMM_BOOKS,TRANSLATION_STATUS',
      next_date => SYSDATE,
